...
const CATEGORY_MAP = { village_clutter: 'props', village_infrastructure: 'village', blacksmith_kit: 'village', farm_kit: 'props', tavern_kit: 'props', nature: 'nature', combat: 'props', landmarks: 'village' };
...
for (const r of report.results) {
  ...
  if (cat) {
    ...
    const isTree = cat.category === 'nature' && (g.scaleMeters || 1) >= 3.5;
